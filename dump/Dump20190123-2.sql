...
INSERT INTO `django_admin_log` VALUES (2,'2019-01-24 02:55:16.351689','4','dandan',2,'[]',1,4);
...
INSERT INTO `django_content_type` VALUES (2,'admin','logentry'),(4,'auth','group'),(3,'auth','permission'),(5,'contenttypes','contenttype'),(6,'sessions','session'),(1,'user','user'),(7,'yanadock','course'),(10,'yanadock','likey'),(8,'yanadock','post'),(11,'yanadock','postlike'),(9,'yanadock','timetable');
...
CREATE TABLE `post` (
  ...
  PRIMARY KEY (`post_id`),
  KEY `userid` (`user_id`),
  KEY `fk_post_course_idx` (`course_id`),
...
INSERT INTO `post` VALUES (2,4,0,'hi','1234','hi','스터디/팀플','2020-01-01 01:01:01','2019-01-02 01:01:01'),(3,4,0,'hi2','1234','hi2','스터디/팀플','2020-01-01 01:01:01','2019-01-02 01:01:01'),(4,4,0,'hi','1234','hi','스터디/팀플','2020-01-01 01:01:01','2019-01-02 01:01:01'),(5,4,0,'hi2','1234','hi2','스터디/팀플','2020-01-01 01:01:01','2019-01-02 01:01:01'),(6,4,0,'hi3','1234','hi3',NULL,'2020-01-01 01:01:01','2019-01-02 01:01:01'),(7,4,1,'hi4','1234','hi4','스터디/팀플','2020-01-01 01:01:01','2019-01-02 01:01:01');
...
INSERT INTO `timetable` VALUES (4,0),(4,1);
...
INSERT INTO `user` VALUES (2,'1234',NULL,0,'ro dan','dan','ro','d@gmail.com',0,1,'2019-01-01 23:59:59.000000','dandandan','고려대학교','2020-01-01'),(3,'pbkdf2_sha256$120000$QZ94i6uzwnWK$V7hMPiiPuKTDI9FHXvcQ8CWjXZ16JCGaNGqaklGSILo=','2019-01-23 10:04:52.871136',0,'qwerty','','','rainy_waltz@naver.com',0,1,'2019-01-23 10:04:35.919614',NULL,'KoreaUniv',NULL),(4,'pbkdf2_sha256$120000$HJwoxKU6Tit2$xBWLRRVGTQt9qsIil2AiBXgDuZfZ0p1A+S2YMx2UUwc=','2019-01-24 02:55:03.551163',1,'dandan','','','dd@gmail.com',1,1,'2019-01-24 02:49:48.892496',NULL,'고려대학교',NULL);
...
-- Dump completed on 2019-01-24  3:07:06
